  ...
  return (
    <div>
      ...
      <main>
        ...
        {/* </div> */}
        <div className="bg-white md:bg-gray-800">
          <div className="lg:h-480  bg-center md:bg-cover md:bg-pact-desktop bg-no-repeat pt-2">
        ...
        <div className=" bg-blue-mobile sm:bg-blue-desktop h-auto">
          ...
          <p className="sm:text-xl sm:container sm:mx-auto sm:px-32 xl:px-60 px-8 py-2 text-white text-center sm:mt-2 font-light">
            ...
            ภายใต้การกําากับดูแลกิจการที่ดีตามที่กฎหมายกําาหนดอย่างเคร่งครัด
            ซึ่งยึดเป็นหลักสําาคัญในการบริหารจัดการ
          </p>
          ...
          <p className="sm:text-xl sm:container sm:mx-auto pb-5 px-8 sm:pb-20 sm:px-32 xl:px-60 text-white text-center mt-4 font-light">
            ...
            ทุกขีดจําากัดสู่โลกการเงินภายใต้เทคโนโลยีที่ปลอดภัย สะดวก ใช้งานง่าย
          </p>
        </div>
